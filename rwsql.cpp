...
rwSql::rwSql(QString dbFilePath, QObject *parent) :  QObject(parent),dbPath(dbFilePath)
{
...
bool  rwSql::findMd5(QString md5, QString name){
    bool ret = false;
    do{
...
void  rwSql::addMd5(QString md5, QString name ){
...
bool  rwSql::delMusicByName(QString name){
    bool ret = false;
    do{
...
bool  rwSql::delmusicByMd5(QString md5){
    bool ret = false;
    do{
